...
# Poisson
# Range: [0,∞]
# Parameters: size = number of events, rate = 𝜆
# Interpretation: Distribution of events that occur during a fixed time interval or sampling effort with a constant rate of independent events; resembles normal with large 𝜆, or exponential with small 𝜆
# Binomial
# Range: [0, # of trials]
...
# Interpretation: mean=𝑠ℎ𝑎𝑝𝑒∗𝑠𝑐𝑎𝑙𝑒, variance=𝑠ℎ𝑎𝑝𝑒∗𝑠𝑐𝑎𝑙𝑒2; generates a variety of shapes (including normal and exponential) for positive continuous variables
# Beta 𝛽
